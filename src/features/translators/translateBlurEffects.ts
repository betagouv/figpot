import { BaseBlurEffect, Effect } from '@figpot/src/clients/figma';
...
export function translateBlurEffects(registry: AbstractRegistry, effect: readonly Effect[], figmaNodeId: string): Blur | undefined {
  ...
  const blur = effect.find((effect) => effect.type === 'BACKGROUND_BLUR' || effect.type === 'LAYER_BLUR') as BaseBlurEffect | null;
